...
*Alternate instructions:* On the desktop, locate the folder titled **RunFiles**. Double-click to open, and locate the file **pre-run.bat**. Double-click on **pre-run.bat**, which will open the command prompt and automatically run the above command. 
